...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->path() === 'doors') active @endif" href="/doors">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Doors</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if(in_array(request()->path(), ['people', 'people/create'])) active @endif"
                   href="/people">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                    ...
                    <span class="nav-link-text ms-1">Peoples</span>
                </a>
            </li>
        </ul>
    </div>
